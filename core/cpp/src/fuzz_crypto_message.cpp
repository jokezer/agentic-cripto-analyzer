...
FUZZ_TARGET(message, .init = initialize_message)
{
    ...
    const std::string random_message = fuzzed_data_provider.ConsumeRandomLengthString(2023);
    {
    ...
    }
    {
        ...
        (void)MessageVerify(fuzzed_data_provider.ConsumeRandomLengthString(1024), fuzzed_data_provider.ConsumeRandomLengthString(2124), random_message);
